          ...
          <div class=" container">
            <div class="grid grid-cols-3 gap-3">
                ...
                <div class="col p-4 mt-8 ">
                    ...
                    <div class="p-4">
                        <span class="text-red-900 font-semibold "> Explication des détails </span>
                        <p class="mt-2">
                            Pour faire une déclaration de naissance , vous devez vous servir de votre extrait d'acte de naissance
                            et de l'extrait du defunt.
                        </p>
                    </div>
                </div>
                ...
                <div class="p-2 col-span-2 pt-8">
                    ...
                    <div class="p-8 bg-white shadow-md rounded-xl  ">
                        ...
                        <form @submit.prevent="Declaration()">
                            ...
                            <span class="text-md text-gray-600 font-bold"> Informations sur le déclarant</span>

                            <div class="grid grid-cols-3 p-4 gap-8">

                                <div>

                                   <label for="decl_num_extrait" class="flex justify-start font-mono text-md text-gray-800 "> Numéro d'extrait </label>
                                ...
                                <div>
                                    <label for="decl_date_extrait" class="flex justify-start font-mono text-md text-gray-800 "> Date d'établissement </label>
                            ...
                            <span class="text-md text-gray-600 font-bol"> Informations sur le défunt</span>

                            <div class="grid grid-cols-3 p-4 gap-8">

                                <div>

                                   <label for="mort_num_extrait" class="flex justify-start font-mono text-md text-gray-800 "> Numéro d'extrait </label>
                                ...
                                <div>
                                    <label for="mort_date_extrait" class="flex justify-start font-mono text-md text-gray-800 "> Date d'établissement  </label>
